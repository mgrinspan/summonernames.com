        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="js-alert" class="modal-body bg-danger">
                    <p>This site is not functional without JavaScript enabled.<br>We are working on non-JavaScript support, but it may be a while.<br><a href="http://enable-javascript.com/">To learn how to enable JavaScript, click here.</a></p>
                </div>
